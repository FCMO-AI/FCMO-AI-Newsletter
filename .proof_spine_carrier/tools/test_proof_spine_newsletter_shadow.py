...
def test_prospective_field_producer_identity_reaches_universal_receipt_context():
    receipt = healthy_receipt()
    ...
    # Footnote: these fields are evidence provenance, not authority. Their purpose is
    # to let calibration prove that the exact preregistered producer channel emitted
